...
const config = {
    ...
    NEWSLETTER_JID: '120363313124070136@newsletter', // UPDATED CHANNEL ID
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: 'FREDI AI MD',
    OWNER_NAME: 'FrediEzra',
    OWNER_NUMBER: '255620814108',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> © powered by fredi ai',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VaihcQv840m8LP59f03f',
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/aw641i.jpg',
        MENU: 'https://files.catbox.moe/aw641i.jpg',
        OWNER: 'https://files.catbox.moe/cw5wuj.jpg',
        SONG: 'https://files.catbox.moe/aw641i.jpg',
        VIDEO: 'https://files.catbox.moe/aw641i.jpg'
    }
};
...
🌐 *Website:*https://fredi-ai-site.vercel.app
...
> *ʜᴇʟʟᴏ ʙʀᴏ 👋, ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ fredi ai bot 🤖, ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ.*

> ᴛᴀᴘ ᴀʟʟᴍᴇɴᴜ ᴛᴏ sᴇᴇ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs

ℹ️ғᴏʀ ʙᴏᴛ ᴜᴘᴅᴀᴛᴇs  
https://whatsapp.com/channel/0029VaihcQv840m8LP59f03f
...
https://fredi-ai-site.vercel.app
  `.trim();
    ...
    await socket.sendMessage(sender, {
        image: { url: "https://files.catbox.moe/aw641i.jpg" },
        caption: text,
    ...
    socket.ev.on('call', async (call) => {
        try {
            ...
            await socket.sendMessage(caller, { 
                text: `❌ Sorry! FREDI AI is not accepting calls. Your call has been rejected.` 
            });
...
case 'winfo': {
    try {
        ...
        let caption = `*📢 fredi ai bot WhatsApp Channel Info*\n\n`;
...
case 'mfire': {
    const axios = require("axios");
    const BOT_NAME = '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ fredi';
...
case 'video': {
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: dlUrl },
            caption: `✅ *fredi ai bot* - Here is your video: *${info.title}*`
        }, { quoted: detailsMsg });
...
//=======================================
 case 'ping': {
    ...
    let ping = await socket.sendMessage(sender, { text: '*_Pinging to fredi ai bot ʙᴏᴛ Module..._* ❗' });
    ...
    return await socket.sendMessage(sender, {
        text: `✅ *Pong:* ${final - inital} ms\n⚡fredi ai bot ʙᴏᴛ is active Get yours https://fredi-ai-site.vercel.app!`,
        edit: ping.key
    });
}
...
case 'owner': {
    ...
    await socket.sendMessage(sender, {
          image: { url: 'https://files.catbox.moe/cw5wuj.jpg' },
        caption: '*👨‍💻 fredi ai bot ʙᴏᴛ ᴏᴡɴᴇʀ*\n\n'
               + '*👤 Name:* fredi\n'
               + '*📞 Number:* wa.me/255620814108\n'
               + '*📧 Email:* frediezra360@gmail.com\n',
        footer: '⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ fredi',
        buttons: [
            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📋 MENU' }, type: 1 },
...
case 'repo': {
                    await socket.sendMessage(sender, {
                        image: { url: 'https://files.catbox.moe/aw641i.jpg' },
                        caption: `🌟 *FREDI AI MD REPOSITORY*\n\n🔗 *GitHub:* https://github.com/Fred1e/fredi-ai\n\n🌟 *Features:*\n• Fast & Reliable\n• Easy to Use\n• Multiple Sessions\n\n> © *ᴘᴏᴡᴇʀᴇᴅ ʙʏ FrediEzra*`
                    });
                    break;
                }
...
case 'about': {
    ...
    try {
        ...
        const setAt = statusData.setAt
            ? moment(statusData.setAt).tz('Africa/Nairobi').format('YYYY-MM-DD HH:mm:ss')
            : 'Unknown';
...
case 'tiktokdl': {
    try {
        ...
        const titleText = '*FREDI TIKTOK DOWNLOADER*';
        const content = `┏━━━━━━━━━━━━━━━━\n` +
...
තව කවෘ හරි මම චමිදු (fredi) කියලා කිව්විත් එයාට ගරු කරලා කතා කරන්න, තව සන්වර විදිහට හොදට හදලා ඔන බන්
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                try {
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'Fredi-Free-Bot-Session'}`);
                }
            }
        });
    } catch (error) {
